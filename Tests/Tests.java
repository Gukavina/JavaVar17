...
public class Tests {
    ...
    void test() {
        ...
        assertEquals(new DecimalFractionalNumber("-722.106"),
                new DecimalFractionalNumber(345.88).subtraction(new DecimalFractionalNumber(1067.986)));
        ...
        assertEquals(new DecimalFractionalNumber("6394.0"),
                new DecimalFractionalNumber(55.6).multiplication(new DecimalFractionalNumber(115)));
